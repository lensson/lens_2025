package com.lens.common.core.utils.ServerInfo;


import com.lens.common.core.utils.Arith;
...
public class ServerInfo {
    ...
    private void setCpuInfo(CentralProcessor processor) {
        ...
        double nice = ticks[TickType.NICE.ordinal()] - prevTicks[NICE.getIndex()];
        double irq = ticks[IRQ.getIndex()] - prevTicks[IRQ.getIndex()];
        double softirq = ticks[SOFTIRQ.getIndex()] - prevTicks[SOFTIRQ.getIndex()];
        double steal = ticks[STEAL.getIndex()] - prevTicks[STEAL.getIndex()];
        double cSys = ticks[SYSTEM.getIndex()] - prevTicks[SYSTEM.getIndex()];
        double user = ticks[USER.getIndex()] - prevTicks[USER.getIndex()];
        double iowait = ticks[IOWAIT.getIndex()] - prevTicks[IOWAIT.getIndex()];
        double idle = ticks[IDLE.getIndex()] - prevTicks[IDLE.getIndex()];
