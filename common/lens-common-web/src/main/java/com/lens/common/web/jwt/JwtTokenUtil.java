package com.lens.common.web.jwt;
...
public class JwtTokenUtil {
    ...
    public String createJWT(String userName, String adminUid, String roleName,
        ...
        JwtBuilder builder = Jwts.builder().setHeaderParam("typ", "JWT")
                .claim(BaseSysConstants.ADMIN_UID, adminUid)
                .claim(BaseSysConstants.ROLE, roleName)
                .claim(BaseSysConstants.CREATE_TIME, now)
                .setSubject(userName)
                .setIssuer(issuer)
    ...
    public String getUserUid(String token, String base64Security) {
        return parseJWT(token, base64Security).get(BaseSysConstants.ADMIN_UID, String.class);
    }
    ...
    public String getAudience(String token, String base64Security) {
        return parseJWT(token, base64Security).getAudience().stream().findFirst().get();
    }
