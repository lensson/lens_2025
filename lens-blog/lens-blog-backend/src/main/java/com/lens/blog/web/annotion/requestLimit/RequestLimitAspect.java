package com.lens.blog.web.annotion.requestLimit;
...
public class RequestLimitAspect {
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        if (requestLimitConfig.getStart()) {
            ...
            String key = RedisConstants.REQUEST_LIMIT + RedisConstants.SEGMENTATION + ip + RedisConstants.SEGMENTATION + methodName;
