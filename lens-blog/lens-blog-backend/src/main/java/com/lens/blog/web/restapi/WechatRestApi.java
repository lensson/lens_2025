...
public class WechatRestApi {
    ...
    public String index(HttpServletRequest request) throws Exception {
        ...
        if (user != null) {
            //将从数据库查询的数据缓存到redis中
            redisUtil.setEx(RedisConstants.USER_TOKEN + Constants.SYMBOL_COLON + ticket, JsonUtils.objectToJson(user), userTokenSurvivalTime, TimeUnit.HOURS);
        }
    ...
    public String getUserLoginStatus(@RequestParam("ticket") String ticket) {
        ...
        String json = redisUtil.get(RedisConstants.USER_TOKEN + Constants.SYMBOL_COLON + ticket);
