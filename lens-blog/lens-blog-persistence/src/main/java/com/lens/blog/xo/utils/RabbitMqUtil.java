...
public class RabbitMqUtil {
    ...
    private void sendEmail(String email, String text) {
        ...
        result.put(SysConstants.SUBJECT, PROJECT_NAME);
    ...
    public void sendCommentEmail(Map<String, String> map) {
        String email = map.get(SysConstants.EMAIL);
        String text = map.get(SysConstants.TEXT);
        String toText = map.get(SysConstants.TO_TEXT);
        String nickName = map.get(SysConstants.NICKNAME);
        String toUserNickName = map.get(SysConstants.TO_NICKNAME);
        String userUid = map.get(SysConstants.USER_UID);
        String url = map.get(SysConstants.URL);
        String content =
                "<html>\r\n" +
                        " <head>\r\n" +
